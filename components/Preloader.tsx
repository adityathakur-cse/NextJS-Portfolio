...
const Preloader = () => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex" ref={preloaderRef}>
            ...
            <p className="name-text flex text-[13vw] lg:text-[140px] font-anton text-center w-full justify-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 leading-none overflow-hidden whitespace-nowrap">
                ...
                <span className="inline-block translate-y-full">A</span>
                <span className="inline-block translate-y-full w-[4vw] lg:w-[2vw]"></span>
                <span className="inline-block translate-y-full">T</span>
